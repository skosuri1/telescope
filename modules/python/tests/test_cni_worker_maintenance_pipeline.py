...
def test_pipeline_binds_complete_plan_and_disables_normal_resume():
    ...
    condition = (
        "${{ if and(eq(parameters.scaleDebugDv3QuotaRequestLimit, 0), eq(parameters.scaleDebugQuotaRequestReceiptBuildId, 0), parameters.scaleDebugCniWorkerMaintenanceOnly, "
