...
def test_pipeline_wires_retirement_before_arm_recovery():
    ...
    assert job["jobs"][0]["condition"] == (
        ...
        "ne(variables['CLUSTERMESH_MODERN_PROM_RECOVERY'], 'true'), "
        ...
        "eq(variables['CLUSTERMESH_QUOTA_REQUEST_RECEIPT_BUILD_ID'], '0'), "
