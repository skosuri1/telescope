...
def test_modern_cni_receipt_disables_legacy_and_normal_jobs():
    ...
    key = "${{ if and(eq(parameters.scaleDebugRetainedWorkerRestartBuildId, 0), ne(parameters.scaleDebugModernCniPromBuildId, 0), eq(parameters.scaleDebugDv3QuotaRequestLimit, 0), eq(parameters.scaleDebugQuotaRequestReceiptBuildId, 0)) }}"
